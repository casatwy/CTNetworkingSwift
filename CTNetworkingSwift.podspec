...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/casatwy/CTNetworkingSwift"
  ...
  s.source       = { :git => "https://github.com/casatwy/CTNetworkingSwift.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CTNetworkingSwift/CTNetworkingSwift/**/*.{swift}"
